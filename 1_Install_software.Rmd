...
it is recommended to work with the most recent versions of both. For the day
of the workshop all licenses will be provided as time-limited training licenses (see below). 
