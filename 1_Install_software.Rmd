...
of the workshop all licenses will be provided as time-limited training licenses. 
As the model benefits significantly from recent improvements in *GAMS* and *CONOPT4* 
